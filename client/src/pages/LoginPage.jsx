...
function LoginPage() {
  ...
  return (
    <div class="flex h-[calc(100vh-100px)] items-center justify-center  dark:border-gray-600 dark:bg-gray-900 dark:text-gray-900">
      <div class="bg-gray-800 text-white max-w-md w-full p-10 rounded-md dark:border-gray-600 dark:bg-white dark:text-gray-900" >
      {
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
      <label class="block uppercase tracking-wide text-white text-xs font-bold mb-2 dark:text-gray-900" for="grid-last-name">
        Email
      </label>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
      <label class="block uppercase tracking-wide text-white text-xs font-bold mb-2 dark:text-gray-900" for="grid-password">
        Password
      </label>
